...
/**
 * We will create:
 *   A web service Endpoint for CRUD operations. 
 *      Endpoint classes accept web service requests
 *      and return web service responses.
 *      
 *  Here we need to use Java classes generated by XSD
 *      files for request and response
 *
 */

// @Endpoint: Classes annotated with this become 
...
public class ArticleEndpoint {
	...
	/**
	 * 
	 * @PayloadRoot: Methods annotated with this becomes an Endpoint method that
	 *                accepts incoming request and returns response. 
	 *  - It has attributes "namespace" & "localPart". 
	 *      -- Attribute "localPart" is required and it signifies the local part 
	 *          of payload root element
	 *      -- Attribute "namespace" is optional and it signifis the namespace 
	 *          of payload root element
	 * 
	 * @ResponsePayload: this annotation bounds the response of the method to 
	 *                     response payload
	 */
